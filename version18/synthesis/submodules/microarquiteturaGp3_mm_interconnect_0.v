...
module microarquiteturaGp3_mm_interconnect_0 (
	...
	wire   [7:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> buttons_s1_agent:cp_channel
	...
	wire  [13:0] bola_x_s1_agent_m0_address;                                                         // bola_x_s1_agent:m0_address -> bola_x_s1_translator:uav_address
	...
	wire  [90:0] bola_x_s1_agent_rf_source_data;                                                     // bola_x_s1_agent:rf_source_data -> bola_x_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] bola_x_s1_agent_rsp_fifo_out_data;                                                  // bola_x_s1_agent_rsp_fifo:out_data -> bola_x_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> bola_x_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // bola_x_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [7:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> bola_x_s1_agent:cp_channel
	...
	wire  [13:0] bola_y_s1_agent_m0_address;                                                         // bola_y_s1_agent:m0_address -> bola_y_s1_translator:uav_address
	...
	wire  [90:0] bola_y_s1_agent_rf_source_data;                                                     // bola_y_s1_agent:rf_source_data -> bola_y_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] bola_y_s1_agent_rsp_fifo_out_data;                                                  // bola_y_s1_agent_rsp_fifo:out_data -> bola_y_s1_agent:rf_sink_data
	...
	wire  [89:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> bola_y_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // bola_y_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> bola_y_s1_agent:cp_channel
	...
	wire  [13:0] barra_e_y_s1_agent_m0_address;                                                      // barra_e_y_s1_agent:m0_address -> barra_e_y_s1_translator:uav_address
	...
	wire  [90:0] barra_e_y_s1_agent_rf_source_data;                                                  // barra_e_y_s1_agent:rf_source_data -> barra_e_y_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] barra_e_y_s1_agent_rsp_fifo_out_data;                                               // barra_e_y_s1_agent_rsp_fifo:out_data -> barra_e_y_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> barra_e_y_s1_agent:cp_valid
	wire  [89:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> barra_e_y_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // barra_e_y_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> barra_e_y_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> barra_e_y_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> barra_e_y_s1_agent:cp_endofpacket
	...
	wire  [13:0] barra_d_y_s1_agent_m0_address;                                                      // barra_d_y_s1_agent:m0_address -> barra_d_y_s1_translator:uav_address
	...
	wire  [90:0] barra_d_y_s1_agent_rf_source_data;                                                  // barra_d_y_s1_agent:rf_source_data -> barra_d_y_s1_agent_rsp_fifo:in_data
	...
	wire  [90:0] barra_d_y_s1_agent_rsp_fifo_out_data;                                               // barra_d_y_s1_agent_rsp_fifo:out_data -> barra_d_y_s1_agent:rf_sink_data
	...
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> barra_d_y_s1_agent:cp_valid
	wire  [89:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> barra_d_y_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // barra_d_y_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> barra_d_y_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> barra_d_y_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> barra_d_y_s1_agent:cp_endofpacket
	...
	wire  [89:0] bola_x_s1_agent_rp_data;                                                            // bola_x_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [89:0] bola_y_s1_agent_rp_data;                                                            // bola_y_s1_agent:rp_data -> router_007:sink_data
	...
	wire         barra_e_y_s1_agent_rp_valid;                                                        // barra_e_y_s1_agent:rp_valid -> router_008:sink_valid
	wire  [89:0] barra_e_y_s1_agent_rp_data;                                                         // barra_e_y_s1_agent:rp_data -> router_008:sink_data
	wire         barra_e_y_s1_agent_rp_ready;                                                        // router_008:sink_ready -> barra_e_y_s1_agent:rp_ready
	wire         barra_e_y_s1_agent_rp_startofpacket;                                                // barra_e_y_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire         barra_e_y_s1_agent_rp_endofpacket;                                                  // barra_e_y_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire         barra_d_y_s1_agent_rp_valid;                                                        // barra_d_y_s1_agent:rp_valid -> router_009:sink_valid
	wire  [89:0] barra_d_y_s1_agent_rp_data;                                                         // barra_d_y_s1_agent:rp_data -> router_009:sink_data
	wire         barra_d_y_s1_agent_rp_ready;                                                        // router_009:sink_ready -> barra_d_y_s1_agent:rp_ready
	wire         barra_d_y_s1_agent_rp_startofpacket;                                                // barra_d_y_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         barra_d_y_s1_agent_rp_endofpacket;                                                  // barra_d_y_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire  [89:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_006:sink1_data
	...
	wire  [89:0] cmd_demux_001_src7_data;                                                            // cmd_demux_001:src7_data -> cmd_mux_007:sink1_data
	...
	wire  [89:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink6_data
	...
	wire  [89:0] rsp_demux_007_src1_data;                                                            // rsp_demux_007:src1_data -> rsp_mux_001:sink7_data
	...
	wire         barra_e_y_s1_agent_rdata_fifo_src_valid;                                            // barra_e_y_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] barra_e_y_s1_agent_rdata_fifo_src_data;                                             // barra_e_y_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         barra_e_y_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_006:in_0_ready -> barra_e_y_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> barra_e_y_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> barra_e_y_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                  // barra_e_y_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> barra_e_y_s1_agent:rdata_fifo_sink_error
	wire         barra_d_y_s1_agent_rdata_fifo_src_valid;                                            // barra_d_y_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] barra_d_y_s1_agent_rdata_fifo_src_data;                                             // barra_d_y_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         barra_d_y_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_007:in_0_ready -> barra_d_y_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> barra_d_y_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> barra_d_y_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // barra_d_y_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> barra_d_y_s1_agent:rdata_fifo_sink_error
	...
	microarquiteturaGp3_mm_interconnect_0_router_002 router_008 (
	...
	microarquiteturaGp3_mm_interconnect_0_router_002 router_009 (
	...
	microarquiteturaGp3_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	microarquiteturaGp3_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	microarquiteturaGp3_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	microarquiteturaGp3_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_qsys_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
