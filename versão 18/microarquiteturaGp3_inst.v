	microarquiteturaGp3 u0 (
		...
		.vga_monitor_bola_x    (<connected-to-vga_monitor_bola_x>),    //            .bola_x
		.vga_monitor_bola_y    (<connected-to-vga_monitor_bola_y>),    //            .bola_y
		.vga_monitor_barra_e_y (<connected-to-vga_monitor_barra_e_y>), //            .barra_e_y
		.vga_monitor_barra_d_y (<connected-to-vga_monitor_barra_d_y>)  //            .barra_d_y
	);
